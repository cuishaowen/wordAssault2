...
!function (t, e) {
    ...
    function lo(t) {
        var e = t.option.source, n = Mx;
        if (S(e)) n = Ix; else if (y(e)) {
            0 === e.length && (n = _x);
    ...
    function co(t) {
        var e = t.option, n = e.data, i = S(n) ? Ix : xx, r = !1, o = e.seriesLayoutBy, a = e.sourceHeader,
    ...
    function fo(t, e, n, i, r) {
        ...
        var o, a, s;
        if (e === _x) "auto" === i || null == i ? go(function (t) {
            null != t && "-" !== t && (_(t) ? null == a && (a = 1) : a = 0)
        }, n, t, 10) : a = i ? 1 : 0, r || 1 !== a || (r = [], go(function (t, e) {
            r[e] = null != t ? t : ""
        }, n, t)), o = r ? r.length : n === Ax ? t.length : t[0] ? t[0].length : null; else if (e === bx) r || (r = mo(t), s = !0); else if (e === Sx) r || (r = [], s = !0, d(t, function (t, e) {
            r.push(e)
        })); else if (e === xx) {
            var l = Tn(t[0]);
            o = y(l) && l.length || 1
    ...
    function go(t, e, n, i) {
        if (null == i && (i = 1 / 0), e === Ax) for (o = 0; o < n.length && o < i; o++) t(n[o] ? n[o][0] : null, o); else for (var r = n[0] || [], o = 0; o < r.length && o < i; o++) t(r[o], o)
    }
    ...
    function vo(t, e, n, i, r, o) {
        ...
        if (a && null != f.get(u)) {
            var p = t.ecModel, g = Cx(p).datasetMap, m = e.uid + "_" + r,
    ...
    function _o(t, e, n, i, r, o) {
        ...
        if (S(t)) return !1;
        var l;
        if (i && (l = w(l = i[o]) ? l.name : l), e === _x) if (n === Ax) {
        ...
        } else if (e === xx) for (u = 0; u < t.length && u < 5; u++) {
            var d = t[u], f = Tn(d);
            if (!y(f)) return !1;
    ...
    function So(t) {
        t = t, this.option = {}, this.option[Dx] = 1, this._componentsMap = N({series: []}), this._seriesIndices, this._seriesIndicesMap, bo(t, this._theme.option), i(t, gx, !1), this.mergeOption(t)
    }
    ...
    function No(t) {
        var e = t && t.itemStyle;
        if (e) for (var n = 0, r = Vx.length; n < r; n++) {
            var o = Vx[n], a = e.normal, s = e.emphasis;
    ...
    function Fo(t, e) {
        var n = Fx(t) && t[e], i = Fx(n) && n.textStyle;
    ...
    function xa(t) {
        var e = t.model, n = t.ecModel, i = t.api, r = t.payload, o = e.pipelineContext.progressiveRender, a = t.view,
            s = r && r_(r).updateMethod, l = o ? "incrementalPrepareRender" : s && a[s] ? s : "render";
    ...
    function Ga(t, e, n, i) {
        ...
        if (1 === t.nodeType && (Ua(t, e), o(r, Xa(t)), !i)) for (var s in D_) if (D_.hasOwnProperty(s)) {
    ...
    function Xa(t) {
        ...
        for (var o in D_) D_.hasOwnProperty(o) && null != i[o] && (n[D_[o]] = i[o]);
        return n
    }
    ...
    function Ja(t, e, n, i, r) {
        ...
        } else R_(t._componentsViews.concat(t._chartsViews), o)
    }
    ...
    function es(t, e) {
        var n = t.type, i = t.escapeConnect, r = Q_[n], s = r.actionInfo, l = (s.update || "update").split(":"),
            h = l.pop();
    ...
    function Vs(t, e, n, i, r) {
        var o = vw[e.type], a = i - 1, s = e.name, l = t[s][a];
        if (l && l.length < n) {
    ...
    function Ys(t, e) {
        var n = t.dimensions, i = new Sw(f(n, t.getDimensionInfo, t), t.hostModel);
        Fs(i, t);
    ...
    function nl(t, e, n) {
        ...
        var s, l, h = Tw(t, {coordDimensions: i, generateCoord: n.generateCoord});
        a && d(h, function (t, e) {
    ...
    function fl(t, e, n, i) {
        ...
        if (!t) return r;
        e[0] < n[0] && r.push(e[0]);
        for (var o = n[0]; o <= n[1] && (r.push(o), (o = kw(o + t, i)) !== r[r.length - 1]);) if (r.length > 1e4) return [];
    ...
    function Ql(t) {
        ...
        var x = Math.max(0, Math.floor(Math.min(v, y))), _ = hb(t.model), w = _.lastAutoInterval, b = _.lastTickCount;
    ...
    function Sh(t, e, n, i, r, o, a, s, l, h, u) {
        for (var c = 0, d = n, f = 0; f < i; f++) {
            ...
            if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Tb(Cb, p); else if (l > 0) {
                var g = d + o, m = e[g];
                if (u) for (; m && _h(e[g]);) m = e[g += o];
                var v = .5, y = e[c];
                if (!(m = e[g]) || _h(m)) Tb(Db, p); else {
                    _h(m) && !u && (m = p), G(Ab, m, y);
                    var x, _;
                    if ("x" === h || "y" === h) {
                        var w = "x" === h ? 0 : 1;
    ...
    function tu(t, e, n) {
        ...
        if (T(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
            var r = e.getModel("axisLabel"), o = r.get("margin"), a = i.getViewLabels(),
                s = (T(n.labelRotate, r.get("rotate")) || 0) * Xb / 180, l = qb(n.rotation, s, n.labelDirection),
    ...
    function wu(t, e, n) {
        ...
        var a = new lS({shape: {points: i.getLayout("largePoints")}, incremental: !!n, __startPoint: r, __valueIdx: o});
        e.add(a), bu(a, t, i)
    }
    ...
    function Zu(t, e, n) {
        var i = n.getZr(), r = bS(i).axisPointerLastHighlights || {}, o = bS(i).axisPointerLastHighlights = {};
        _S(t, function (t, e) {
    ...
    function xc(t) {
        ...
        return n && e.push(vc(n)), i && (Kp.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + Vt(i)), e.push("filter:alpha(opacity=70)"))), PS(["width", "color", "radius"], function (n) {
            var i = "border-" + n, r = LS(i), o = t.get(r);
    ...
    function Fc(t, e) {
        ...
        if (e && !Rc(e) && !y(e.coord) && r) {
            ...
            if ((e = n(e)).type && JS[e.type] && a.baseAxis && a.valueAxis) {
                var s = KS(o, a.baseAxis.dim), l = KS(o, a.valueAxis.dim);
                e.coord = JS[e.type](i, a.baseDataDim, a.valueDataDim, s, l), e.value = e.coord[l]
            } else {
                for (var h = [null != e.xAxis ? e.xAxis : e.radiusAxis, null != e.yAxis ? e.yAxis : e.angleAxis], u = 0; u < 2; u++) JS[h[u]] && (h[u] = Zc(i, i.mapDimension(o[u]), h[u]));
                e.coord = h
            }
        }
        return e
    ...
    function Xc(t, e, n) {
        ...
        var r = new Sw(i, n), o = f(n.get("data"), v(Fc, e));
    ...
    function hd(t, e, n) {
        ...
        var r = new Sw(i, n), o = new Sw(i, n), s = new Sw([], n), l = f(n.get("data"), v(sM, e, t, n));
        t && (l = g(l, v(sd, t)));
    ...
    function pd(t, e, n) {
        ...
        }), n)) : r = new Sw(i = [{name: "value", type: "float"}], n);
    ...
    function Cf(t, e, n, i) {
        var r = i.brushStyle.lineWidth || 0, o = $M(r, tI), a = n[0][0], s = n[1][0], l = a - r / 2, h = s - r / 2,
    ...
    function Df(t, e) {
        ...
        r.useStyle(Pf(n)), r.attr({
            ...
            r && r.attr({silent: !i, invisible: !i, cursor: i ? iI[o] + "-resize" : null})
        })
    }
    ...
    function Lf(t, e, n, i) {
        var r = [qM(t, n), qM(e, i)], o = [$M(t, n), $M(e, i)];
    ...
    function Ff(t) {
        var e = qM(t[0][0], t[1][0]), n = qM(t[0][1], t[1][1]);
        return {x: e, y: n, width: $M(t[0][0], t[1][0]) - e, height: $M(t[0][1], t[1][1]) - n}
    }
    ...
    function Vf(t, e, n) {
        if (t._brushType) {
            ...
            if (!t._dragging) for (var a = 0; a < r.length; a++) {
                ...
                if (o && (!0 === o || s.panelId === o.panelId) && sI[s.brushType].contain(r[a], n[0], n[1])) return
            }
    ...
    function tp(t, e) {
        return zn(t, e, {includeMainTypes: fI})
    }
            ...
            switch (n[r++]) {
                ...
                case fT.A:
                    var s = n[r++], l = n[r++], h = n[r++], u = n[r++], c = n[r++], d = n[r++], f = n[r++], p = n[r++],
                        g = Math.abs(d), m = bp(g - _T) && !bp(g), v = !1;
                    v = g >= _T || !bp(g) && (d > -xT && d < 0 || d > xT) == !!p;
                    var y = wp(s + h * yT(c)), x = wp(l + u * vT(c));
                    m && (d = p ? _T - 1e-4 : 1e-4 - _T, v = !0, 9 === r && e.push("M", y, x));
                    var _ = wp(s + h * yT(c + d)), w = wp(l + u * vT(c + d));
    ...
    var qm = (Object.freeze || Object)({
            version: "4.0.6", init: wn, dispose: function (t) {
                if (t) t.dispose(); else {
    ...
    var qy = 0, $y = 1e-4,
        ...
        nx = ["a", "b", "c", "d", "e", "f", "g"], ix = function (t, e) {
            return "{" + t + (null == e ? "" : e) + "}"
        }, rx = Le, ox = Te, ax = (Object.freeze || Object)({
            addCommas: Zr,
            toCamelCase: Ur,
            ...
            truncateText: rx,
            getTextRect: ox
        }), sx = d, lx = ["left", "right", "top", "bottom", "width", "height"],
        hx = [["width", "left", "right"], ["height", "top", "bottom"]], ux = Qr,
    ...
    Un(fx, {registerWhenExtend: !0}), function (t) {
        var e = {};
    ...
    var gx = {
            ...
            clearColorPalette: function () {
                ...
                var i = mx(e = e || this), r = i.colorIdx || 0, o = i.colorNameMap = i.colorNameMap || {};
        ...
        }, xx = "original", _x = "arrayRows", bx = "objectRows", Sx = "keyedColumns", Mx = "unknown", Ix = "typedArray",
        Tx = "column", Ax = "row";
    so.seriesDataToSource = function (t) {
        return new so({data: t, sourceFormat: S(t) ? Ix : xx, fromDataset: !1})
    }, Wn(so);
    var Cx = On(), Dx = "\0_ec_inner", kx = Ir.extend({
        init: function (t, e, n, i) {
    ...
    var Ox = d, zx = n, Ex = f, Nx = i, Rx = /^(min|max)?(.+)$/;
    ko.prototype = {
    ...
    var Bx = d, Fx = w, Vx = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
        Hx = function (t, e) {
    ...
    var Xx = {
        ...
        }, objectRows: {pure: !0, count: qo, getItem: $o, appendData: Ko}, keyedColumns: {
            pure: !0, count: function () {
        ...
        }, original: {count: qo, getItem: $o, appendData: Ko}, typedArray: {
    ...
    var Jx = On(), t_ = fx.extend({
        ...
        getColorFromPalette: function (t, e, n) {
            var i = this.ecModel, r = vx.getColorFromPalette.call(this, t, e, n);
    ...
    e_.prototype = {
        constructor: e_, init: function (t, e) {
        }, render: function (t, e, n, i) {
        }, dispose: function () {
        }, filterForExposedEvent: null
    };
    var n_ = e_.prototype;
    n_.updateView = n_.updateLayout = n_.updateVisual = function (t, e, n, i) {
    }, Hn(e_), Un(e_, {registerWhenExtend: !0});
    var i_ = function () {
        var t = On();
        return function (e) {
    ...
    var s_ = {
    ...
    }, l_ = "\0__throttleOriginMethod", h_ = "\0__throttleRate", u_ = "\0__throttleType", c_ = {
        ...
        function i(t) {
            var e = o.get(t);
            if (null == e) {
                for (var n = t.split("."), i = d_.aria, r = 0; r < n.length; ++r) i = i[n[r]];
                return i
            }
            return e
        }
    ...
    M_.categoryAxis.splitLine.show = !1, fx.extend({
        type: "dataset",
        defaultOption: {seriesLayoutBy: Tx, sourceHeader: null, dimensions: null, source: null},
        optionUpdated: function () {
            lo(this)
        }
    }), e_.extend({type: "dataset"});
    var I_ = Ii.extend({
    ...
    var A_ = {
        ...
        }, N_ = P, R_ = d, B_ = x, F_ = w, V_ = fx.parseClassType, H_ = {zrender: "4.0.6"}, W_ = 1e3, G_ = 1e3, Z_ = 3e3,
        U_ = {
            PROCESSOR: {FILTER: W_, STATISTIC: 5e3},
            VISUAL: {LAYOUT: G_, GLOBAL: 2e3, CHART: Z_, COMPONENT: 4e3, BRUSH: 5e3}
        }, X_ = "__flagInMainProcess", Y_ = "__optionUpdated", j_ = /^[a-zA-Z0-9_]+$/;
    ...
    q_._onframe = function () {
        ...
        if (F_(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[X_] = !0, !this._model || e) {
            var r = new ko(this._api), o = this._theme, a = this._model = new kx(null, null, o, r);
            a.scheduler = this._scheduler, a.init(null, null, o, r)
        }
        this._model.setOption(t, ew), n ? (this[Y_] = {silent: i}, this[X_] = !1) : (Qa(this), $_.update.call(this), this._zr.flush(), this[Y_] = !1, this[X_] = !1, ns.call(this, i), is.call(this, i))
    ...
    q_.resize = function (t) {
        ...
        if (F_(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), ow[t]) {
            var n = ow[t](this._api, e), i = this._zr;
        ...
        F_(e) || (e = {silent: !!e}), Q_[t.type] && this._model && (this[X_] ? this._pendingActions.push(t) : (es.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : !1 !== e.flush && Kp.browser.weChat && this._throttledZrFlush(), ns.call(this, e.silent), is.call(this, e.silent)))
    ...
    var Q_ = {}, J_ = {}, tw = [], ew = [], nw = [], iw = [], rw = {}, ow = {}, aw = {}, sw = {}, lw = new Date - 0,
        hw = new Date - 0, uw = "_echarts_instance_", cw = vs;
    Ms(2e3, c_), _s(Zx), ws(5e3, function (t) {
        ...
        var n = new My({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4}), i = new Dy({
            shape: {startAngle: -p_ / 2, endAngle: -p_ / 2 + .1, r: 10},
        ...
        i.animateShape(!0).when(1e3, {endAngle: 3 * p_ / 2}).start("circularInOut"), i.animateShape(!0).when(1e3, {startAngle: 3 * p_ / 2}).delay(300).start("circularInOut");
        var o = new am;
    ...
    var fw = N(["tooltip", "label", "itemName", "itemId", "seriesName"]), pw = w, gw = -1, mw = "e\0\0", vw = {
        ...
        bw = ["_extent", "_approximateExtent", "_rawExtent"], Sw = function (t, e) {
            t = t || ["x", "y"];
    ...
    Mw.type = "list", Mw.hasItemOption = !0, Mw.getDimension = function (t) {
        ...
        if (pw(t)) for (var n in t) t.hasOwnProperty(n) && this.setVisual(n, t[n]); else this._visual = this._visual || {}, this._visual[t] = e
    }, Mw.setLayout = function (t, e) {
        if (pw(t)) for (var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]); else this._layout[t] = e
        ...
        if (this._itemVisuals[t] = i, pw(e)) for (var o in e) e.hasOwnProperty(o) && (i[o] = e[o], r[o] = !0); else i[e] = n, r[e] = !0
    ...
    var Cw = ol.prototype, Dw = ol.extend({
    ...
    var Ow = "__ec_stack_", zw = "undefined" != typeof Float32Array ? Float32Array : Array, Ew = {
        seriesType: "bar", plan: i_(), reset: function (t) {
            if (_l(t) && wl(t)) {
                ...
                return h > .5 || (h = .5), {
                    progress: function (t, e) {
                        for (var i, u = new zw(2 * t.count), c = [], d = [], f = 0; null != (i = t.next());) d[l] = e.get(o, i), d[1 - l] = e.get(a, i), c = n.dataToPoint(d, null, c), u[f++] = c[0], u[f++] = c[1];
                        e.setLayout({largePoints: u, barWidth: h, valueAxisStart: bl(0, r), valueAxisHorizontal: s})
                    }
                }
            }
        }
    }, Nw = Lw.prototype, Rw = Math.ceil, Bw = Math.floor, Fw = function (t, e, n, i) {
        for (; n < i;) {
            var r = n + i >>> 1;
            t[r][1] < e ? n = r + 1 : i = r
        }
        ...
        type: "time", getLabel: function (t) {
            ...
            var a = Hw.length, s = Fw(Hw, o, 0, a), l = Hw[Math.min(s, a - 1)], h = l[1];
    ...
    Vw.create = function (t) {
        return new Vw({useUTC: t.ecModel.get("useUTC")})
    };
    var Ww = ol.prototype, Gw = Lw.prototype, Zw = Er, Uw = Lr, Xw = Math.floor, Yw = Math.ceil, jw = Math.pow,
        qw = Math.log, $w = ol.extend({
    ...
    var rb = Bi({
        type: "symbol", shape: {symbolType: "", x: 0, y: 0, width: 0, height: 0}, beforeBrush: function () {
            ...
            var i = e.symbolType, r = ib[i];
            "none" !== e.symbolType && (r || (r = ib[i = "rect"]), nb[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(t, r.shape, n))
        }
    }), ob = {isDimensionStacked: tl, enableDataStack: Js, getStackedDimension: el}, ab = (Object.freeze || Object)({
        createList: function (t) {
            return nl(t.getSource(), t)
        }, getLayoutRect: Jr, dataStack: ob, createScale: function (t, e) {
            var n = e;
            ...
            u(t, Kw)
        }, completeDimensions: $s, createDimensions: Tw, createSymbol: Nl
    }), sb = 1e-8;
    Fl.prototype = {
    ...
    var gb = oh.prototype, mb = oh.getSymbolSize = function (t, e) {
    ...
    gb._createSymbol = function (t, e, n, i, r) {
        ...
        this.silent = !1;
        var i = t.getItemVisual(e, "symbol") || "circle", r = t.hostModel, o = mb(t, e), a = i !== this._symbolType;
        if (a) {
    ...
    var vb = ["itemStyle"], yb = ["emphasis", "itemStyle"], xb = ["label"], _b = ["emphasis", "label"];
    ...
    }, Sb = K, Mb = Q, Ib = W, Tb = F, Ab = [], Cb = [], Db = [], kb = Ii.extend({
        type: "ec-polyline",
    ...
    ga.extend({
        type: "line", init: function () {
            ...
            var a = this._polyline, s = this._polygon, l = t.hostModel,
                h = bb(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, o), u = h.current,
    ...
    var Lb = function (t, e, n) {
        ...
        return {
            seriesType: t, plan: i_(), reset: function (t) {
    ...
    Nb.prototype = {
        constructor: Nb, type: "cartesian", getAxis: function (t) {
            return this._axes[t]
        }, getAxes: function () {
    ...
    }, Bb), Fb.valueAxis = i({boundaryGap: [0, 0], splitNumber: 5}, Bb), Fb.timeAxis = a({
        scale: !0,
        min: "dataMin",
        max: "dataMax"
    }, Fb.valueAxis), Fb.logAxis = a({scale: !0, logBase: 10}, Fb.valueAxis);
    var Vb = ["value", "category", "time", "log"], Hb = function (t, e, n, o) {
        d(Vb, function (a) {
            e.extend({
        ...
        function i(n) {
            return function (i, s) {
                if (Fh(i, t, e)) {
                    ...
                    var h = new Rb(n, Al(i), [0, 0], i.get("type"), l), u = "category" === h.type;
    ...
    var Xb = Math.PI, Yb = function (t, e) {
    ...
    Yb.prototype = {
        constructor: Yb, hasBuilder: function (t) {
            return !!jb[t]
        }, add: function (t) {
            jb[t].call(this)
        }, getGroup: function () {
    ...
    var tS = ["axisLine", "axisTickLabel", "axisName"], eS = ["splitArea", "splitLine"], nS = Qb.extend({
        type: "cartesianAxis", axisPointerClass: "CartesianAxisPointer", render: function (t, e, n, i) {
            ...
            if (this._axisGroup = new am, this.group.add(this._axisGroup), t.get("show")) {
                var o = t.getCoordSysModel(), a = pu(o, t), s = new Yb(t, a);
    ...
    nS.extend({type: "xAxis"}), nS.extend({type: "yAxis"}), Cs({
    ...
    o(Ir.prototype, rS), ks({
        type: "bar", render: function (t, e, n) {
            ...
            o.diff(a).add(function (e) {
                if (o.hasValue(e)) {
                    var n = o.getItemModel(e), a = sS[s.type](o, e, n), l = aS[s.type](o, e, n, a, i, h);
                    o.setItemGraphicEl(e, l), r.add(l), xu(l, o, e, n, a, t, i, "polar" === s.type)
                }
            }).update(function (e, n) {
                var l = a.getItemGraphicEl(n);
                if (o.hasValue(e)) {
                    var u = o.getItemModel(e), c = sS[s.type](o, e, u);
                    l ? vr(l, {shape: c}, h, e) : l = aS[s.type](o, e, u, c, i, h, !0), o.setItemGraphicEl(e, l), r.add(l), xu(l, o, e, u, c, t, i, "polar" === s.type)
                } else r.remove(l)
            }).remove(function (t) {
    ...
    var hS = function (t, e, n) {
        ...
        var i = t.getSource(), r = Tw(i, e), a = new Sw(r, t);
        ...
        getDataParams: function (t) {
            var e = this.getData(), n = cS.superCall(this, "getDataParams", t), i = [];
    ...
    !function (t, e) {
        ...
        e.eachSeriesByType(t, function (t) {
            ...
            var a = n.getWidth(), s = n.getHeight(), l = Math.min(a, s), h = Pr(r[0], a), u = Pr(r[1], s),
                c = Pr(o[0], l / 2), d = Pr(o[1], l / 2), f = -t.get("startAngle") * gS, p = t.get("minAngle") * gS,
                g = 0;
            e.each(i, function (t) {
                !isNaN(t) && g++
            });
    ...
    Qb.registerAxisPointerClass("CartesianAxisPointer", DS), _s(function (t) {
        ...
        if (s) {
            Yu(r) && (r = xS({seriesIndex: o.seriesIndex, dataIndex: o.dataIndex}, e).point);
            var l = Yu(r), h = o.axesInfo, u = s.axesInfo, c = "leave" === i || Yu(r), d = {}, f = {},
                p = {list: [], map: {}}, g = {showPointer: wS(Vu, f), showTooltip: wS(Hu, p)};
    ...
    var PS = d, LS = Ur, OS = ["", "-webkit-", "-moz-", "-o-"];
    _c.prototype = {
    ...
    var zS = m, ES = d, NS = Pr, RS = new My({shape: {x: -1, y: -1, width: 2, height: 2}});
    Cs({
        type: "tooltip", init: function (t, e) {
            ...
            if (i.from !== this.uid && !Kp.node) {
                ...
                if (i.tooltip && null != i.x && null != i.y) {
                    ...
                    var s = xS(i, e), l = s.point[0], h = s.point[1];
            ...
            if (a && d.applyTransform(a.transform), "function" == typeof e && (e = e([n, i], o, r.el, d, {
                    viewSize: [s, l],
                    contentSize: h.slice()
                })), y(e)) n = NS(e[0], s), i = NS(e[1], l); else if (w(e)) {
    ...
    var FS = v, VS = d, HS = am, WS = Cs({
        type: "legend.plain", newlineDisabled: !1, init: function () {
            ...
            n.eachRawSeries(function (t) {
                ...
                } else r.add(new HS({newline: !0}))
            }, this)
        }, _createItem: function (t, e, n, i, r, a, s, l, h) {
            var u = i.get("itemWidth"), c = i.get("itemHeight"), d = i.get("inactiveColor"),
                f = i.get("symbolKeepAspect"), p = i.isSelected(t), g = new HS, m = n.getModel("textStyle"),
    ...
    var GS = BS.extend({
    ...
    }), ZS = am, US = ["width", "height"], XS = ["x", "y"], YS = WS.extend({
        type: "legend.scroll", newlineDisabled: !0, init: function () {
            ...
            var r = this.getContentGroup(), o = this._containerGroup, a = this._controllerGroup,
                s = t.getOrient().index, l = US[s], h = US[1 - s], u = XS[1 - s];
            ...
            var i = t.get("scrollDataIndex", !0), r = this.getContentGroup(), o = this._containerGroup.__rectSize,
                a = t.getOrient().index, s = US[a], l = XS[a], h = this._findTargetItemIndex(i), u = r.children(),
    ...
    var jS = Zr, qS = Xr, $S = As({
        type: "marker", dependencies: ["series", "grid", "polar", "geo"], init: function (t, e, n, i) {
            ...
            var e = this.getData(), n = this.getRawValue(t), i = y(n) ? f(n, jS).join(", ") : jS(n), r = e.getName(t),
                o = qS(this.name);
    ...
    var KS = l, QS = v, JS = {min: QS(Bc, "min"), max: QS(Bc, "max"), average: QS(Bc, "average")}, tM = Cs({
    ...
    var eM = Ty.prototype, nM = Cy.prototype, iM = Bi({
        type: "ec-line",
        style: {stroke: "#000", fill: null},
        ...
        tangentAt: function (t) {
            var e = this.shape, n = Yc(e) ? [e.x2 - e.x1, e.y2 - e.y1] : nM.tangentAt.call(this, t);
            return Y(n, n)
        }
    }), rM = ["fromSymbol", "toSymbol"], oM = Qc.prototype;
    ...
    var uM = ["cartesian2d", "polar", "singleAxis"], cM = function (t, e) {
        ...
        }(["x", "y", "z", "radius", "angle", "single"], ["axisIndex", "axis", "index", "id"]), dM = d, fM = Or,
        pM = function (t, e, n, i) {
    ...
    pM.prototype = {
        constructor: pM, hostedBy: function (t) {
            ...
            }), {valueWindow: fM(a), percentWindow: fM(o)}
        }, reset: function (t) {
    ...
    var gM = d, mM = cM, vM = As({
        ...
        }), _M = My, wM = kr, bM = Or, SM = m, MM = d, IM = "horizontal", TM = 5,
        AM = ["line", "bar", "candlestick", "scatter"], CM = yM.extend({
            type: "dataZoom.slider", init: function (t, e) {
                ...
                var t = this.dataZoomModel, e = this.api, n = this._findCoordRect(),
                    i = {width: e.getWidth(), height: e.getHeight()}, r = this._orient === IM ? {
                ...
                o.attr(n !== IM || r ? n === IM && r ? {scale: a ? [-1, 1] : [-1, -1]} : "vertical" !== n || r ? {
                    scale: a ? [-1, -1] : [-1, 1],
                    rotation: Math.PI / 2
                ...
                if (t) {
                    ...
                    if (null != r) {
                        ...
                        i.each([r], function (t, e) {
                            if (g > 0 && e % g) p += f; else {
                                var n = null == t || isNaN(t) || "" === t, i = n ? 0 : wM(t, o, h, !0);
                ...
                var s = this._range, l = this._range = bM([wM(i[0], r, a, !0), wM(i[1], r, a, !0)]);
                return !s || s[0] !== l[0] || s[1] !== l[1]
            }, _updateView: function (t) {
                var e = this._displayables, n = this._handleEnds, i = bM(n.slice()), r = this._size;
                MM([0, 1], function (t) {
                ...
                function e(t) {
                    var e = xr(i.handles[t].parent, this.group), n = wr(0 === t ? "right" : "left", e),
                        s = this._handleWidth / 2 + TM, l = _r([c[t] + (0 === t ? -s : s), this._size[1] / 2], e);
                    r[t].setStyle({
                        x: l[0],
                        y: l[1],
    ...
    var kM = "\0_ec_dataZoom_roams", PM = m, LM = yM.extend({
    ...
    var WM = d_.toolbox.dataView, GM = new Array(60).join("-"), ZM = "\t", UM = new RegExp("[" + ZM + "]+", "g");
    uf.defaultOption = {
        show: !0,
        readOnly: !1,
    ...
    var XM = v, YM = d, jM = f, qM = Math.min, $M = Math.max, KM = Math.pow, QM = 1e4, JM = 6, tI = 6, eI = "globalPan",
        nI = {w: [0, 0], e: [0, 1], n: [1, 0], s: [1, 1]},
        iI = {w: "ew", e: "ew", n: "ns", s: "ns", ne: "nesw", sw: "nesw", nw: "nwse", se: "nwse"}, rI = {
            ...
            lineX: Xf(0), lineY: Xf(1), rect: {
                ...
                createCover: function (t, e) {
                    ...
                    e.remove(e.childAt(0)), e.add(new _y({
                        ...
                        draggable: !0,
                        drift: XM(Nf, t, e),
                        ondragend: XM(Mf, t, {isEnd: !0})
                    }))
                }, updateCoverShape: function (t, e, n, i) {
                    e.childAt(0).setShape({points: Bf(t, e, n)})
                }, updateCommon: Df, contain: Wf
            }
        }, lI = {axisPointer: 1, tooltip: 1, brush: 1}, hI = d, uI = l, cI = v, dI = ["dataToPoint", "pointToData"],
        fI = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"], pI = Qf.prototype;
    pI.setOutputRanges = function (t, e) {
        this.matchOutputRanges(t, e, function (t, e, n) {
            if ((t.coordRanges || (t.coordRanges = [])).push(e), !t.coordRange) {
                ...
                t.__rangeOffset = {offset: xI[t.brushType](i.values, t.range, [1, 1]), xyMinMax: i.xyMinMax}
            }
        })
        ...
        hI(t, function (t) {
            ...
            if (t.range = t.range || [], n && !0 !== n) {
                t.panelId = n.panelId;
                var i = yI[t.brushType](0, n.coordSys, t.coordRange), r = t.__rangeOffset;
        ...
        for (var n = this._targetInfoList, i = tp(e, t), r = 0; r < n.length; r++) {
            ...
            } else for (r = 0; r < mI.length; r++) if (mI[r](i, o)) return o
        }
        return !0
    };
    var gI = {
        ...
        lineX: cI(ep, 0), lineY: cI(ep, 1), rect: function (t, e, n) {
            var i = e[dI[t]]([n[0][0], n[1][0]]), r = e[dI[t]]([n[0][1], n[1][1]]),
        ...
        lineX: cI(np, 0), lineY: cI(np, 1), rect: function (t, e, n) {
    ...
    }, _I = d, wI = "\0_ec_hist_store";
    vM.extend({type: "dataZoom.select"}), yM.extend({type: "dataZoom.select"});
    var bI = d_.toolbox.dataZoom, SI = d, MI = "\0_ec_\0toolbox-dataZoom_";
    up.defaultOption = {
        show: !0,
        icon: {
            ...
            if (e) {
                ...
                null == o || "all" === o || y(o) || (o = !1 === o || "none" === o ? [] : [o]), n(t, function (e, n) {
                    if (null == o || "all" === o || -1 !== l(o, n)) {
                        var a = {type: "select", $fromToolbox: !0, id: MI + t + n};
                        a[r] = n, i.push(a)
                    }
                })
            }
    ...
    var CI, DI = "urn:schemas-microsoft-com:vml", kI = "undefined" == typeof window ? null : window, PI = !1,
        LI = kI && kI.document;
    if (LI && !Kp.canvasSupported) try {
    ...
    var OI = Hv.CMD, zI = Math.round, EI = Math.sqrt, NI = Math.abs, RI = Math.cos, BI = Math.sin, FI = Math.max;
    if (!Kp.canvasSupported) {
        var VI = 21600, HI = VI / 2, WI = function (t) {
            ...
            var n, i, r, o, a, s, l = OI.M, h = OI.C, u = OI.L, c = OI.A, d = OI.Q, f = [], p = t.data, g = t.len();
            for (o = 0; o < g;) {
                switch (r = p[o++], i = "", n = 0, r) {
                    ...
                    case c:
                        ...
                        o++;
                        var O = p[o++], z = A + RI(P) * D, E = C + BI(P) * k, y = A + RI(L) * D, x = C + BI(L) * k,
                            N = O ? " wa " : " at ";
        ...
        hn.prototype.brushVML = function (t) {
            ...
            if (r) {
                ...
                if (this.transform && (x = this.transform, b = EI(x[0] * x[0] + x[1] * x[1]), S = EI(x[2] * x[2] + x[3] * x[3]), w = x[1] || x[2]), w) {
                    ...
                    var C = FI(M[0], I[0], T[0], A[0]), D = FI(M[1], I[1], T[1], A[1]), k = [];
                ...
                } else x && (h = h * b + x[4], u = u * S + x[5]), _.filter = "", _.left = zI(h) + "px", _.top = zI(u) + "px";
                var P = this._imageEl, L = this._cropEl;
                P || (P = LI.createElement("div"), this._imageEl = P);
                var O = P.style;
                if (v) {
                    if (e && n) O.width = zI(b * e * c / f) + "px", O.height = zI(S * n * d / p) + "px"; else {
                ...
                } else O.width = zI(b * c) + "px", O.height = zI(S * d) + "px", y.appendChild(P), L && L.parentNode && (y.removeChild(L), this._cropEl = null);
                var R = "", B = i.opacity;
        ...
        var iT, rT = {}, oT = 0, aT = document.createElement("div"), sT = function (t) {
            var e = rT[t];
            if (!e) {
                oT > 100 && (oT = 0, rT = {});
                var n, i = aT.style;
        ...
        !function (t, e) {
            ...
            return iT.innerHTML = "", iT.appendChild(n.createTextNode(t)), {width: iT.offsetWidth}
        });
        for (var lT = new se, hT = [zm, ln, hn, Ii, dy], uT = 0; uT < hT.length; uT++) {
            ...
            cT.drawRectText = function (t, e, n, i) {
                ...
                if (null != o && (o += ""), o) {
                    ...
                    var c, d, f = r.textAlign, p = r.textVerticalAlign, g = sT(r.font),
                        m = g.style + " " + g.variant + " " + g.weight + " " + g.size + 'px "' + g.family + '"';
                    n = n || Te(o, m, f, p, r.textPadding, r.textLineHeight);
                    var v = this.transform;
                    if (v && !i && (lT.copy(e), lT.applyTransform(v), e = lT), i) c = e.x, d = e.y; else {
                        var y = r.textPosition, x = r.textDistance;
                        if (y instanceof Array) c = e.x + jI(y[0], e.width), d = e.y + jI(y[1], e.height), f = f || "left"; else {
                            var _ = Pe(y, e, x);
                    ...
                    JI(I, "fill", {fill: r.textFill, opacity: r.opacity}, this), JI(I, "stroke", {
                        stroke: r.textStroke,
                        opacity: r.opacity,
                        lineDash: r.lineDash
    ...
    var dT = "http://www.w3.org/2000/svg", fT = Hv.CMD, pT = Array.prototype.join, gT = "none", mT = Math.round,
        vT = Math.sin, yT = Math.cos, xT = Math.PI, _T = 2 * Math.PI, wT = 180 / xT, bT = 1e-4, ST = {};
    ST.brush = function (t) {
    ...
    var IT = {}, TT = new se, AT = function (t, e, n) {
        var i = t.style;
        t.__dirty && Ge(i);
        var r = i.text;
        if (null != r) {
            ...
            if (Tp(o, "x", a), Tp(o, "y", s), Cp(o, i, !0, t), t instanceof dy || t.style.transformText) Ip(o, t.transform); else {
                if (t.transform) TT.copy(e), TT.applyTransform(t.transform), e = TT; else {
    ...
    var CT = new Pp, DT = function (t, e, n) {
    ...
    kT.prototype = {
        constructor: kT, getType: function () {
            return "svg"
        }, getViewportRoot: function () {
