...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/chaptersubject/chapter/">chapterSubject列表</a></li>
		<li class="active"><a href="${ctx}/chaptersubject/chapter/form?id=${chapter.id}">chapterSubject<shiro:hasPermission name="chaptersubject:chapter:edit">${not empty chapter.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="chaptersubject:chapter:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="chapter" action="${ctx}/chaptersubject/chapter/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">父级id (课程id)：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="chaptersubject:chapter:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
