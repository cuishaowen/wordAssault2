...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/userchaptersubject/userChapterSubject/">userchaptersubject列表</a></li>
		<li class="active"><a href="${ctx}/userchaptersubject/userChapterSubject/form?id=${userChapterSubject.id}">userchaptersubject<shiro:hasPermission name="userchaptersubject:userChapterSubject:edit">${not empty userChapterSubject.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="userchaptersubject:userChapterSubject:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userChapterSubject" action="${ctx}/userchaptersubject/userChapterSubject/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">用户id：</label>
			<div class="controls">
				<sys:treeselect id="engUserId" name="engUserId" value="${userChapterSubject.engUserId}" labelName="" labelValue="${userChapterSubject.}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="userchaptersubject:userChapterSubject:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
